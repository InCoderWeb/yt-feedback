...
const BentoCard = ({
	...
	<BlurFade
		...
		className={cn(
			...
			// light styles
			"bg-gradient-to-t from-red-300/20 to-rose-200/0 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]",
			// dark styles
			"transform-gpu dark:bg-background dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
			className
		)}
	>
		<div className="flex flex-col justify-between overflow-hidden" {...props}>
			<div>{background}</div>
			<div
